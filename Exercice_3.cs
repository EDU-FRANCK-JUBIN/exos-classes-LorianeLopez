...
namespace Exercice3_Classe
{
    ...
    class Article
    {
        ...
        public Article( int prixHT, int tauxTVA)
        {
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Article casque = new Article("854987458", "Casque Audio Haute Qualité", 240, 20);
            ...
            Article livre = new Article(15, 20);
